...
public class AnimatedSprite extends TiledSprite {
    ...
    public void animate(final long pFrameDurationEach, final int pFrameCount, final boolean pLoop) {
        this.mAnimationData.set(pFrameDurationEach, pFrameCount, pLoop);
